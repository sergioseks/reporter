...
SRC:=$(GOPATH)/src/github.com/sergioseks/reporter
...
.PHONY: buildlinux 
buildlinux: 	
	cmd //v //c "set GOOS=linux&&go install -v github.com/sergioseks/reporter/cmd/grafana-reporter"
...
.PHONY: docker-build
docker-build:
	@docker build -t sergioseks/grafana-reporter:2.3.0 -t sergioseks/grafana-reporter:latest .

docker-push:
	@docker push sergioseks/grafana-reporter
